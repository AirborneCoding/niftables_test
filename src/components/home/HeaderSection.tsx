...
const HeaderSection = () => {
    ...
    const handleVideoError = () => {
        setVideoError(true); // Set error state to true if video fails to load/play
    };
    return (
        <section className="relative h-[970px] self-stretch bg-[url(/images/img_group_27.png)] bg-cover bg-no-repeat md:h-auto">
            ...
            {videoError ? (
                <img src="/images/defaultImage.jpg" alt="Fallback Image" className="absolute top-0 left-0 w-full h-full object-cover" />
            ) : (
                <video
                    autoPlay
                    loop
                    ...
                    onError={handleVideoError} // Handle video error event
                >
